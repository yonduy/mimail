            ...
            <div class="container">
                            ...
                            <ul>
                                <li class="product">
                                    <a href="" target="_blank">
                                        ...
                                        <div class="pro-name">小米全面屏E5A</div>
                ...
                <div class="header-search">
                    <div class="wrapper">
                        ...
                        <a href="javascript:;"></a> <!-- 开发时为了点击不刷新，将href设置为javascript，防止跳转 -->
                    </div>
                </div>
            </div>
        </div>
            ...
            .container{
                ...
                .header-search{
                    ...
                    .wwapper{
                        ...
                        input{
                            border:none;
                            box-sizing:border-box;  /* 将padding算到设定的宽度里面 */
                        ...
                        a{
                            ...
                            /* background-size:contain; /* 让图片充满整个标签 */ 
                            margin-left: 17px;
                        }
                    }
                }
